...
console.VERTICAL_MARGIN = 0 -- Vertical margins between components.
console.PROMPT = "> " -- The prompt symbol.

console.MAX_LINES = 2000 -- How many lines to store in the buffer.
console.HISTORY_SIZE = 2000 -- How much of history to store.
